...
///////////////////////////////////
  // 尻尾キャリブレーション部
	...
	sequence = sequence->setNextSequence(		new Sequence(new LineTraceAction(80, 2),	new DistanceCondition(4550)));
	sequence = sequence->setNextSequence(		new Sequence(new LineTraceAction(35, 2),	new DistanceCondition(700))	);
	sequence = sequence->setNextSequence(		new Sequence(new LineTraceAction(80, 2),	new DistanceCondition(1250)));
	sequence = sequence->setNextSequence(		new Sequence(new LineTraceAction(40, 2),	new DistanceCondition(1100)));
//////////////////////////////////////
//ゴール
//////////////////////////////////////
//////////////////////////////////////
