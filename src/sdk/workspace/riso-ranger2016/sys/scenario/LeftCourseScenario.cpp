...
//	sequence = firstSequence->setNextSequence(	new Sequence(new LineTraceAction(20, 60),	new DistanceCondition(100))		);
//	sequence = firstSequence->setNextSequence(	new Sequence(new TailBrakeAction(),			new TimeCondition(1000))		);
	sequence = firstSequence->setNextSequence(	new Sequence(new LineTraceAction(20, 60),	new DistanceToObjectCondition(300))	);
	sequence = sequence->setNextSequence(		new Sequence(new LineTraceAction(10, 60),	new DistanceToObjectCondition(200))		);
