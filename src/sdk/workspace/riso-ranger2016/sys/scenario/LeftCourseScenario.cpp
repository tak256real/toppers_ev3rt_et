...
//	sequence = firstSequence->setNextSequence(		new Sequence(new LineTraceAction(40, 10),	new DistanceToObjectCondition(200))		);
	sequence = firstSequence->setNextSequence(		new Sequence(new LineTraceAction(100, 10),	new DistanceToObjectCondition(20))		);	sequence = sequence->setNextSequence(		new Sequence(new TailBrakeAction(),			new TimeCondition(1000))		);
