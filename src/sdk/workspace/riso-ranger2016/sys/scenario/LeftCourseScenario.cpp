...
void LeftCourseScenario::start(){
	...
	// スタート部
	sequence = sequence->setNextSequence(	new Sequence(new LineTraceAction(10, 45, new PIDControl(40, 0, 0)),	new TimeCondition(3000))		);	// スタート直後はゆっくり走行
	sequence = sequence->setNextSequence(	new Sequence(new LineTraceAction(10, 45, new PIDControl(80, 0, 3000)),	new EmptyCondition())		);	// 直線終わりまで
